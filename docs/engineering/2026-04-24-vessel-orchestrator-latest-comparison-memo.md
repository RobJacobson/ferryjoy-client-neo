...
- `convex/functions/vesselOrchestrator/actions/updateVesselOrchestrator.ts`
  ...
  - `updateVesselOrchestrator`
    - `runOrchestratorPing`
      ...
      - `createUpdateVesselTripDbAccess`
        - targeted schedule readers (`actions/ping/updateVesselTrip/updateVesselTripDbAccess.ts`)
...
Production uses `createUpdateVesselTripDbAccess` ([`actions/ping/updateVesselTrip/updateVesselTripDbAccess.ts`](../../convex/functions/vesselOrchestrator/actions/ping/updateVesselTrip/updateVesselTripDbAccess.ts)), which exposes two narrow methods:
