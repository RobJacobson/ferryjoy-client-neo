/**
 * Date conversion utilities to replace Zod codecs
 *
 * These functions handle conversion between epoch milliseconds (number) and Date objects
 * for the domain layer (Date objects) and Convex storage (numbers).
 */
 ...
 */
export const dateToEpochMs = (ms: Date): number => ms.getTime();
