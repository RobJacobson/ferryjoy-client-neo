 ...
 * Keeping the guard here localizes a critical invariant: orchestration should
 * not proceed when identity tables are empty, because location normalization
 * and trip inference both depend on those tables being populated.
 *
