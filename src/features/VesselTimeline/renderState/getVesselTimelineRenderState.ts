 ...
 * @param args.rows - Backend-owned timeline rows for the day
 * @param args.activeRowId - Backend-owned active row identifier
...
/**
 * Resolves the active row index from the backend-owned row id.
 *
 * @param rows - Backend-owned timeline rows for the day
 * @param activeRowId - Backend-owned active row identifier
