...
export const THEME = {
  light: {
    ...
    sidebar: "hsl(267.5676 90.2439% 91.9608%)",
    sidebarForeground: "hsl(216.9231 19.1176% 26.6667%)",
    sidebarPrimary: "hsl(255.1351 91.7355% 76.2745%)",
    sidebarPrimaryForeground: "hsl(0 0% 100%)",
    sidebarAccent: "hsl(292.5000 44.4444% 92.9412%)",
    sidebarAccentForeground: "hsl(216.9231 19.1176% 26.6667%)",
    sidebarBorder: "hsl(267.5676 90.2439% 91.9608%)",
    sidebarRing: "hsl(255.1351 91.7355% 76.2745%)",
  },
  dark: {
    ...
    sidebar: "hsl(272.5000 19.3548% 24.3137%)",
    sidebarForeground: "hsl(226.4516 100% 93.9216%)",
    sidebarPrimary: "hsl(255.9036 95.4023% 82.9412%)",
    sidebarPrimaryForeground: "hsl(24 9.8039% 10%)",
    sidebarAccent: "hsl(266.8966 19.2053% 29.6078%)",
    sidebarAccentForeground: "hsl(216.0000 12.1951% 83.9216%)",
    sidebarBorder: "hsl(272.5000 19.3548% 24.3137%)",
    sidebarRing: "hsl(255.9036 95.4023% 82.9412%)",
  },
} as const;
