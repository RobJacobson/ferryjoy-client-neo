...
export default function Layout() {
  ...
  const [fontsLoaded, fontError] = useFonts({
    ...
    "BitcountPropSingle-100": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-Thin.ttf"),
    "BitcountPropSingle-200": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-ExtraLight.ttf"),
    "BitcountPropSingle-300": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-Light.ttf"),
    "BitcountPropSingle-400": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-Regular.ttf"),
    "BitcountPropSingle-500": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-Medium.ttf"),
    "BitcountPropSingle-600": require("../../assets/fonts/led/BitcountPropSingle/BitcountPropSingle_Cursive-SemiBold.ttf"),
