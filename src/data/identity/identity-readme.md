...
- [src/data/identity/index.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/index.ts) (public API — import `@/data/identity`)
- [src/data/identity/catalog.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/catalog.ts) (in-memory catalog and lookups)
- [src/data/identity/vessels.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/vessels.ts)
- [src/data/identity/terminals.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/terminals.ts)
- [src/data/identity/terminalsTopology.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/terminalsTopology.ts)
- [src/data/identity/utils.ts](/Users/rob/code/ferryjoy/ferryjoy-client-neo/src/data/identity/utils.ts) (shared index helpers)
